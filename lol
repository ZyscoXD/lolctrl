        ...
        elseif msg == Settings['Prefix'].."infosend" then
            ...
            if player.UserId == Alts[1] then
                ...
                function OnlineAlts()
                    local a = 0
                    function CheckPlr(b)
                        for c, d in pairs(game.Players:GetChildren()) do
                            if d.UserId == b then
                                return true
                            end
                        end
                    ...
                    for c, d in pairs(Alts) do
                        if CheckPlr(d) == true then
                            a = a + 1
                        end
                    end
                    return a
                ...
                function GetPing()
                    local a = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
                    local b = string.split(a, '(')
                    local c = tonumber(b[1])
                    c = tonumber(string.format("%.0f", c))
                    return c
                end
            
                function GetDropped()
                    local a = 0
                    for b, c in pairs(game.Workspace.Ignored.Drop:GetChildren()) do
                        if c.Name == "MoneyDrop" and c:IsA("Part") then
                            local d = c:FindFirstChild("BillboardGui"):FindFirstChild("TextLabel").Text
                            if d then
                                d = d:gsub("%,", "")
                                d = d:gsub("%$", "")
                                a = a + tonumber(d)
                ...
                function ListOnlineAlts()
                    ...
                    for c, d in pairs(Alts) do
                        if CheckPlr(d) == true then
                            a = a .. "" .. game.Players:GetPlayerByUserId(d).Name .. "\n"
                        end
                    end
                ...
                function getCashPot()
                    local a = 0
                    for b, c in pairs(game.Players:GetChildren()) do
                        if not game.Workspace.Players:FindFirstChild(c.Name) then
                            repeat
                                wait()
                            until game.Workspace.Players:FindFirstChild(c.Name)
                        end
                        a = a + c.DataFolder.Currency.Value
                    end
                    return a
                end
